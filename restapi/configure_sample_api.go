...
import (
	...
	"github.com/swagger_example/restapi/operations"
)

//go:generate swagger generate server --target ../../swagger_example --name SampleAPI --spec ../swagger.yaml --principal interface{}
